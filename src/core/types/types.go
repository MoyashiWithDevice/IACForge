...
var RelationTypeSourceKinds = map[core.RelationType][]core.EntityKind{
	...
	BelongsTo:    {kinds.VM, kinds.Container, kinds.Interface, kinds.Server, kinds.Switch, kinds.Router, kinds.Firewall, kinds.Storage, kinds.ACL, kinds.ACLRule, kinds.OpenPort, kinds.AvailabilityZone},
...
var RelationTypeTargetKinds = map[core.RelationType][]core.EntityKind{
	...
	BelongsTo:    {kinds.Cluster, kinds.Network, kinds.Region, kinds.Firewall, kinds.Interface, kinds.Server, kinds.VM, kinds.Container, kinds.Application},
	ReplicatesTo: {kinds.VM, kinds.Container, kinds.Application, kinds.Storage},
